...
os.chdir(r'C:/Users/aldeg/Documents/Programming/Wind/Wind_exam/Louis/Prep/Deflection/data')
...
pitch_angles = np.arange(0,0.5,1)
...
if Exercise == True:
    for loads_file, pitch_angle in zip(loads_files, pitch_angles):
        ...
        if plot == True:
            ...
            plt.title(f'Loads for {loads_file}')
            plt.xlabel('Radius (m)')
            plt.ylabel('Load (kN)')
            plt.legend()
